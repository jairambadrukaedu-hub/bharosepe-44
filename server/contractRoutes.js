/**
 * CONTRACT ROUTES WRAPPER - CommonJS to ES Module Bridge
 * 
 * This file converts ES module contractRoutes to CommonJS for use with Express server
 */
...
router.post('/generate', async (req, res) => {
  try {
    ...
    const { generateContract } = await import('../services/contractGenerationService.js');
